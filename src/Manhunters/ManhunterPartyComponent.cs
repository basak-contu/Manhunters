...
namespace Manhunters
{
    ...
    public class ManhunterPartyComponent : WarPartyComponent
    {
        ...
        public static MobileParty CreateManhunterParty(string stringId, Hero hero, Vec2 position, float spawnRadius, Settlement spawnSettlement, Hero partyLeader, bool isAfterPlayer)
        {
            return MobileParty.CreateParty(hero.CharacterObject.StringId + stringId, new ManhunterPartyComponent(hero, partyLeader, isAfterPlayer), delegate (MobileParty mobileParty)
            {
        ...
        protected internal ManhunterPartyComponent(Hero owner, Hero leader, bool isAfterPlayer)
        {
            Owner = owner;
            _leader = leader;
        ...
        private void InitializeManhunterPartyProperties(MobileParty mobileParty, Vec2 position, float spawnRadius, Settlement spawnSettlement)
        {
            ...
            EquipmentElement horse = new EquipmentElement(MBObjectManager.Instance.GetObject<ItemObject>("empire_horse"));
            ...
            troopsWithHorses.Equipment.AddEquipmentToSlotWithoutAgent(EquipmentIndex.Horse, horse);
